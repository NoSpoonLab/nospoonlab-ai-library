...
namespace AICore.Infrastructure.NoSpoonAI.Types.Request
{
    ...
    public abstract class NoSpoonAITransformerPromptRequest : NoSpoonAIRequest
    {
        ...
        /// </summary>
        private NoSpoonAIExampleData _examplePrompts = new NoSpoonAIExampleData();

        /// <summary>
        /// The function mode to control how the model should interpret and act on function calls.
        /// </summary>
        private object _functionMode;

        /// <summary>
        /// A list of functions that can be invoked in the conversation.
        /// </summary>
        ...
        public virtual void Initialize()
        {
            ...
            if(!string.IsNullOrEmpty(ExamplePrompts().Input)) AddMessage(ExamplePrompts().Input, AIRole.User);
            if(!string.IsNullOrEmpty(ExamplePrompts().Output)) AddMessage(ExamplePrompts().Output, AIRole.Assistant);
            if (FunctionMode() != null) _request.function_call = FunctionMode();
            if (FunctionMode() != null && Functions().Count != 0) _request.functions = Functions();
        ...
        /// </summary>
        public NoSpoonAIExampleData ExamplePrompts() => _examplePrompts;

        /// <summary>
        /// Getter for function mode.
        /// </summary>
        public object FunctionMode() => _functionMode;
        ...
        /// </summary>
        public void ExamplePrompts(NoSpoonAIExampleData value) => _examplePrompts = value;

        /// <summary>
        /// Setter for function mode.
        /// </summary>
        public void FunctionMode(object value) => _functionMode = value;

        /// <summary>
        /// Setter for functions list.
        /// </summary>
        public void Functions(List<Function> value) => _functions = value;
