...
namespace AICore.Services.Types.Response
{
    ...
    public class AITransformerResponse
    {
        ...
        {
            var content = generated.Last().message.functionCall.arguments;
    ...
    public class DataContent
    {
        ...
        /// </summary>
        public FunctionContent functionCall;
    }

    /// <summary>
    /// Represents a function call made during the AI model's conversation.
    /// The function call includes the name of the function, and the arguments.
    /// </summary>
    [Serializable]
